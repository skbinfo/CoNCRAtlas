...
rem+=" ${outdir}/pfam_out ${outdir}/pfam_tblout ${outdir}/pfam_domtblout ${outdir}/pfam_pfamtblout"
...
#$featureCounts -a ${outdir}/lncRNA.gtf -o ${outdir}/lncRNA_gene_count_exon.out ${all_bam} -T $threads -p
